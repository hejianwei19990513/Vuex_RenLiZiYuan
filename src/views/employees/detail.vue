        ...
        <el-tabs>
          <el-tab-pane label="登录账户设置">
            ...
            <el-form ref="userForm" :model="userInfo" :rules="rules" label-width="120px" style="margin-left: 120px; margin-top:30px">
              ...
              <el-form-item>
                <el-button type="primary" @click="editPwd">更新</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
...
import jobDetail from './components/userjob.vue'
export default {
  components: {
    userDetail,
    jobDetail
  ...
  data: function() {
    return {
      userComponent: 'userDetail',
      jobComponent: 'jobDetail',

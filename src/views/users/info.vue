...
import { saveUserPersonalInfo, getUserPersonalInfo } from '@/api/employees'
...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      await saveUserPersonalInfo(user)
    ...
    async getUserInfo() {
      ...
      const personData = await getUserPersonalInfo(this.userId)

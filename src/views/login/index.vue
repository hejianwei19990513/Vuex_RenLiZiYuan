...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        mobile: [{ required: true, trigger: 'blur', message: '手机号不能为空' }, { required: true, trigger: 'blur', validator: validateMobile }],
        password: [{ required: true, trigger: 'blur', message: '密码不能为空' }, { required: true, trigger: 'blur', validator: validatePassword }]
      },
      loading: false,
